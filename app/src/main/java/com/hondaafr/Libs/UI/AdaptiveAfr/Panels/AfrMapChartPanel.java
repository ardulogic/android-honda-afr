...
public class AfrMapChartPanel extends Panel implements AfrComputerListener {
    ...
    public String getListenerId() {
        return "adaptive_afr_map_chart_panel";
    }

    public AfrMapChartPanel(MainActivity mainActivity, TripComputer tripComputer, UiView parent, AfrComputer afrComputer) {
        super(mainActivity, tripComputer, parent);
        this.afrComputer = afrComputer;
        
        mapChart = rootView.findViewById(R.id.adaptiveMapChart);
        initChart();
